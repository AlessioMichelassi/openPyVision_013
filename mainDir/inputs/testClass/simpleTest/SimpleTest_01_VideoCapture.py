...
from mainDir.inputs.old.videoCaptureX import VideoCapture
...
class VideoApp(QApplication):
    def __init__(self, argv):
        ...
        self.input1 = VideoCapture(self.synchObject, input_index=5, isUSB_Cam=True)
        self.widget = QWidget()
        ...
        self.uiTimer.start(1000 // 30)  # Update UI at 60 FPS
